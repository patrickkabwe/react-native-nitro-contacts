...
namespace margelo::nitro::nitrocontacts {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NitroContact).
   */
  struct NitroContact {
  public:
  ...
  public:
    explicit NitroContact(std::string id): id(id) {}
  };
...
namespace margelo::nitro {
  ...
  struct JSIConverter<NitroContact> final {
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const NitroContact& arg) {
